...
exports.FONT_PRESETS = exports.COLOR_PRESETS = void 0;
exports.generateTextFavicon = generateTextFavicon;
exports.svgToPng = svgToPng;
exports.svgToIco = svgToIco;
exports.generateAllFormats = generateAllFormats;
exports.svgToDataUrl = svgToDataUrl;
exports.pngBase64ToDataUrl = pngBase64ToDataUrl;
/**
 * Generates an SVG favicon from text/initials
 * This is instant - pure string generation
 */
function generateTextFavicon(config) {
 ...
 */
async function generateAllFormats(config) {
 ...
 */
function pngBase64ToDataUrl(base64) {
